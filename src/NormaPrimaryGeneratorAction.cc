...
//	fParticleGun->SetParticlePosition(G4ThreeVector(-29.35 * CLHEP::mm, 96.075 * CLHEP::mm, -157.84 * CLHEP::mm));
	fParticleGun->SetParticlePosition(G4ThreeVector(14.0621 * mm, 96.2425 * mm, -137.51 * mm)); //14.49
	...
	fParticleGun->SetParticleMomentumDirection(G4ThreeVector(1., 1.025, 0.)); // -1 backwards
